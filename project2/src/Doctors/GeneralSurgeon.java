...
public class GeneralSurgeon extends AbstractDoctor implements ISurgeon {

    public GeneralSurgeon(String type, boolean isSurgeon, int maxForTreatment) {
        super(type, isSurgeon, maxForTreatment);
        treatedIllnesses = new IllnessType[]{IllnessType.ABDOMINAL_PAIN, IllnessType.BURNS, IllnessType.CAR_ACCIDENT, IllnessType.CUTS, IllnessType.SPORT_INJURIES};
    }
    ...
    public void sendPatientHome(IPatient patient) {
        patient.setPacientState(State.HOME_SURGEON);
    }
