...
public class UrgencyEstimator {
    ...
    private UrgencyEstimator(){
        algorithm = new HashMap<Urgency, HashMap<IllnessType, Integer>>() {
            {
                put(Urgency.IMMEDIATE, new HashMap<IllnessType, Integer>() {
                            {
                ...
                put(Urgency.URGENT, new HashMap<IllnessType, Integer>() {
                            {
                ...
                put(Urgency.LESS_URGENT, new HashMap<IllnessType, Integer>() {
                            {
